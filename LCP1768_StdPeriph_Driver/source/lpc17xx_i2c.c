...
static uint32_t I2C_Start (LPC_I2C_TypeDef *I2Cx)
{
	uint8_t __attribute__((unused)) dummy = I2Cx->I2DAT;  // Clear Data Register
...
void I2C_Init(LPC_I2C_TypeDef *I2Cx, uint32_t clockrate)
{
	...
	if (I2Cx == LPC_I2C0)
	{
		...
		// SDA0
		pin_config.Pinnum = 27;
		PINSEL_ConfigPin(&pin_config);

		// SCL0
		pin_config.Pinnum = 28;
		PINSEL_ConfigPin(&pin_config);
		...
		// Peripheral clock for I2C0 module = FCCLK / 2
